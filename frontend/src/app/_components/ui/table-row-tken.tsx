...
const TableRowToken: FunctionComponent<TableRowTokenType> = ({
	...
	return (
		<div
			className={`self-stretch border-purple-400 border-b-[1px] border-solid flex flex-row items-center justify-start p-[0.5rem] text-left text-[1rem] text-primary font-h3 ${className}`}
		>
