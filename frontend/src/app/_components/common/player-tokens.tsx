...
const PlayerTokens: FunctionComponent<PlayerTokensType> = ({
	...
	return (
		<div
			className={`self-stretch rounded-lg border-purple-400 border-[1px] border-solid overflow-hidden flex flex-col items-start justify-start text-left text-[1.25rem] text-primary font-h3 ${className}`}
		>
