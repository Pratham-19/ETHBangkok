...
const PlayerProfile: FunctionComponent<PlayerProfileType> = ({
	...
	return (
		<>
			<div
				className={`self-stretch rounded-lg bg-purple-600 border-rainbow border-[2px] border-solid box-border overflow-hidden flex flex-row items-center justify-start flex-wrap content-center py-[0.562rem] px-[0.625rem] gap-[0.625rem] min-h-[7rem] cursor-pointer text-left text-[2rem] text-primary font-h3 ${className}`}
				onClick={openModalvr}
			>
				<img
				...
				<div className="flex-1 flex flex-col items-start justify-center gap-[0.25rem] min-w-[9.438rem]">
					<h1 className="m-0 self-stretch relative text-inhfont-semiboldabold font-[inherit]">
						UserName
					</h1>
