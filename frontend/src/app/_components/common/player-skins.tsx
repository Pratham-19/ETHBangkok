...
const PlayerSkins: FunctionComponent<PlayerSkinsType> = ({
  ...
  return (
    <div
      className={`self-stretch flex flex-col items-start justify-start gap-[0.5rem] max-w-full text-left text-[1.5rem] text-primary   ${className}`}
    >
      <h3 className="m-0 self-stretch relative text-inherfont-semiboldold  ">
        My Skins
      </h3>
