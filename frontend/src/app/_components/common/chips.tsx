...
const Chips: FunctionComponent<ChipsType> = ({
	...
	return (
		showChips && (
			<div
				className={`rounded-sm border-primary border-[1px] border-solid flex flex-row items-center justify-start p-[0.25rem] gap-[0.125rem] text-left text-[0.75rem] text-primary font-h3 ${className}`}
				data-chips={chips}
				style={chipsStyle}
			>
				<img
