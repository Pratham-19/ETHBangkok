  ...
  return (
    <div className="w-full relative bg-purple-800 overflow-hidden flex flex-col items-center justify-start p-[1rem] box-border gap-[2rem] leading-[normal] tracking-[normal]">
      <IntroNotificationBar
        ...
        frameSectionBackgroundImage={!select ? "" : "url('/frame-69@3x.png')"}
      />
      <section className="self-stretch flex flex-col items-end justify-between min-h-[16.25rem] text-left text-[1.5rem] text-primary">
        <div className="self-stretch flex flex-col items-start justify-start gap-[1rem]">
          <h3 className="m-0 self-stretch relative text-inherit font-semibold ">
